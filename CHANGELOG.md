...
- Apple Help Book: Help → BANAL Help (⌘?) now opens a bundled, searchable Help Book in the macOS Help Viewer. The book keeps one concise landing page covering the core writing, filing, finding, reading, and publishing paths.
